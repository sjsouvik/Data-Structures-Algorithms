...
const verticalTraversal = (root) => {
    ...
    // creating array from the map and sorting based on the horizontal distance
    let res = Array.from(map).sort((a, b) => a[0] - b[0]);        
    
    // forming a new array by removing horizontal distance(key of the map) and taking out the value part of the map
