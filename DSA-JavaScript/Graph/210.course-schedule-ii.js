...
/* Topological sorting / Kahn's BFS algorithm has been used to solve this problem.
Time complexity: O(V + E), space complexity: O(V + E) where V is the number of courses and 
...
function findOrder(numCourses, prerequisites) {
  ...
  while (queue.length) {
    ...
    output.push(completedCourse);

    for (const course of adjacencyList[completedCourse]) {
      inDegree[course]--;
